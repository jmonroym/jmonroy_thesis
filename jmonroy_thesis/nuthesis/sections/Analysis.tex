...
In this section, the specific definitions of the physical objects in terms of the numerical values assigned to the reconstruction parameters are presented; thus, the provided details summarize and complement the descriptions presented in previous chapters. 
...
if they have p T > 5 GeV and | η | < 2.4. In the same-sign dilepton event categories, the relative
uncertainty in the muon p T from the fit is required to be better than 20% to ensure a high-quality
charge measurement.
...
for the analysis if they have p T > 7 GeV and | η | < 2.5. To suppress electrons with a mis-
...
In particular, the ratio between the lepton p T and the reconstructed jet p T , and the transverse
...
cone size depending on the lepton p T [27, 28]), and the impact parameters of the lepton trajec-
