...
Figure \ref{fig:cp_limits_bgonly} shows the expected background-only and observed asymptotic limits on the combined \tH + \ttH cross section times BR as a function of $\cos(\alpha_{CP})$ for the combination of the $3l$, $\mumu$, and $\emu$ channels. 
