...
\chapter[Search for production of a Higgs boson and a single top quark]{Search for production of a Higgs boson and a single top quark in multilepton final states in pp collisions at $\sqrt{s}=13$ TeV}\label{ch:analysis}
...
Finally, the best fit values of the combined \tH + \ttH cros sections times the BR as a function of the CP-mixing angle, are showed in Figure~\ref{fig:bf_r}. 
