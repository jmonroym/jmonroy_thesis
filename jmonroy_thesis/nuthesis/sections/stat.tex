...
\beqn
p'_r= \frac{p_r}{1-p_b} \equiv CL_s
\eeqn
...
%According to the Wilks' theorem \cite{wilks}, with a sample  a large number of events, in an experiment where two hypothesis $H_0$ and $H_1$ defined in terms of sets of parameters
