...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{pixel/bondpad_region}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.48\textwidth]{pixel/time_delays1.png} 
    \includegraphics[width=0.48\textwidth]{pixel/time_delays2.png}
