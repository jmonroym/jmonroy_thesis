...
and are obtained from the location of the HDI/BBM fiducial marks.   

This basic routine is repeated  


consists of depositing linear sylgard traces that covers 
...
the fiducials on the HDI and BBM for each module, then, using the technical specifications of the HDI and BBM,      



An encapsulation sessions was defined as the process where 8 modules are encapsulated following the encapsulation routine workflow shown in Figure \ref{fig:potting_workflow}.



The module assembly sites will
...
It was observed that even choosing as reference to deposit the sylgard the edge of the bond, the whole bondpad is covered which also increase the safe distance.
