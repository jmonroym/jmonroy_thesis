...
decays through direct interaction to particle/antiparticle pairs ($\bbbar, \tau^+\tau^-, c\bar{c}, \mu^+\mu^-$).
...
\section{The CP-mixing in \tH processes}\label{sec:cp}
